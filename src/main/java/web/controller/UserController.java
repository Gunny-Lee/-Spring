...
public class UserController {
	...
	@ResponseBody
	public List<UserVO> getUserListJson() {
	...
	public String addUserProc(@ModelAttribute("user") UserVO vo,HttpServletRequest request,
			BindingResult errors) {
		/* String username = (String) request.getParameter("username"); String userid =
